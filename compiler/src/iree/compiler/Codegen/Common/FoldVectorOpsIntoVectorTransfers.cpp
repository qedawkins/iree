...
#define GEN_PASS_DEF_FOLDVECTOROPSINTOVECTORTRANSFERSPASS
#include "iree/compiler/Codegen/Common/Passes.h.inc"

namespace {

struct FoldVectorOpsIntoVectorTransfersPass
    : public impl::FoldVectorOpsIntoVectorTransfersPassBase<
...
public:
  ...
  LogicalResult matchAndRewrite(vector::TransposeOp op,
    ...
    // The insertion point needs to be at the transfer read to maintain
    // ordering of memory effects.
    rewriter.setInsertionPoint(sourceRead);
...
public:
  ...
  LogicalResult matchAndRewrite(vector::BroadcastOp op,
    ...
    auto sourceVectorType = cast<VectorType>(op.getSourceType());

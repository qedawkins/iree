...
LogicalResult setMatmulOpConfig(
    ...
    unsigned softwarePipelineStoreStage = defaultCoopMatrixSoftwarePipelineStoreStage);
...
LogicalResult setCooperativeMatrixConfig(
    ...
    unsigned softwarePipelineStoreStage = defaultSimtSoftwarePipelineStoreStage);

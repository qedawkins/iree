...
constexpr unsigned AMDCoopMatrixSoftwarePipelineDepth = 0;
constexpr unsigned AMDCoopMatrixSoftwarePipelineStoreStage = 2;
...
static LogicalResult setAMDMatmulConfig(linalg::LinalgOp op,
  ...
  return setMatmulOpConfig(limits, op, workgroupXY, threadMNK,
                           /*enablePromotion=*/true, AMDSimtSoftwarePipelineDepth,

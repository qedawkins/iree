...
// CHECK-SAME:       lowering_config = #iree_gpu.lowering_config<{thread = [4 : index], workgroup = [128 : index]}>
...
// CHECK-SAME:     thread = [1 : index, 4 : index, 0 : index]
// CHECK-SAME:     workgroup = [1 : index, 128 : index, 0 : index]
...
//  CHECK-DAG: #[[TRANSLATION:.+]] = #iree_codegen.translation_info<LLVMGPUTileAndFuse workgroup_size = [1, 32, 1] subgroup_size = 32>
//      CHECK: func.func @inner_unit_dim()
// CHECK-SAME:     translation_info = #[[TRANSLATION]]
//      CHECK:   linalg.generic
// CHECK-SAME:       lowering_config = #iree_gpu.lowering_config<{thread = [1 : index, 1 : index], workgroup = [32 : index, 1 : index]}>

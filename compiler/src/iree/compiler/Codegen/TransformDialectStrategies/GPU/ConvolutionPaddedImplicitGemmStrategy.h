...
class ConvolutionPaddedImplicitGemmStrategy : public AbstractConvolutionStrategy {
 public:
  ...
  ConvolutionPaddedImplicitGemmStrategy(const ConvolutionPaddedImplicitGemmStrategy &) = default;
  ConvolutionPaddedImplicitGemmStrategy &operator=(const ConvolutionPaddedImplicitGemmStrategy &) = default;
...
void buildConvolutionPaddedImplicitGemmStrategy(ImplicitLocOpBuilder &b, Value variantH,

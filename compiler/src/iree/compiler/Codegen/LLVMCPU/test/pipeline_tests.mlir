// RUN: iree-opt --pass-pipeline='builtin.module(iree-codegen-llvmcpu-configuration-pipeline, func.func(iree-codegen-lower-dispatch-using-pipeline-attr), func.func(iree-llvmcpu-check-ir-before-llvm-conversion))' --iree-llvmcpu-mlir-opt-level=O2 --split-input-file %s | FileCheck %s

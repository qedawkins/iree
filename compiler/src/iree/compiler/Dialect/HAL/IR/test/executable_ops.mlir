...
// CHECK-LABEL: @ex_with_condition_region
hal.executable @ex_with_condition_region {
  // CHECK: hal.executable.variant public @backend target(#executable_target_format
  // CHECK-SAME: if(%[[DEVICE:.+]]: !hal.device) -> i1 {
  hal.executable.variant @backend target(#executable_target_format) if(%device: !hal.device) -> i1 {

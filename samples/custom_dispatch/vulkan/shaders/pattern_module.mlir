...
module {
  pdl.pattern : benefit(1) {
    ...
    pdl.rewrite %mul {
      ...
      %dims = pdl.apply_native_rewrite "convert_index_to_i32"(%workload : !pdl.range<value>) : !pdl.range<value>
      %arg_range = pdl.range %dims, %lhs, %rhs : !pdl.range<value>, !pdl.value, !pdl.value

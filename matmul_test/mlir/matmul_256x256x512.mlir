...
func.func @matmul_256x256x512(%lhs: tensor<256x512xf16>, %rhs: tensor<256x512xf16>) -> tensor<256x256xf32> {
  ...
  } ins(%lhs, %rhs : tensor<256x512xf16>, tensor<256x512xf16>) outs(%fill : tensor<256x256xf32>) {

...
func.func @matmul_256x256x4096(%lhs: tensor<256x4096xf16>, %rhs: tensor<256x4096xf16>) -> tensor<256x256xf32> {
  ...
  } ins(%lhs, %rhs : tensor<256x4096xf16>, tensor<256x4096xf16>) outs(%fill : tensor<256x256xf32>) {

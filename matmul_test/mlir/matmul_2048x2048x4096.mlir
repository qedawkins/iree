...
func.func @matmul_2048x2048x4096(%lhs: tensor<2048x4096xf16>, %rhs: tensor<2048x4096xf16>) -> tensor<2048x2048xf32> {
  ...
  } ins(%lhs, %rhs : tensor<2048x4096xf16>, tensor<2048x4096xf16>) outs(%fill : tensor<2048x2048xf32>) {

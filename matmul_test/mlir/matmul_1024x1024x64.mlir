...
func.func @matmul_1024x1024x64(%lhs: tensor<1024x64xf16>, %rhs: tensor<1024x64xf16>) -> tensor<1024x1024xf32> {
  ...
  } ins(%lhs, %rhs : tensor<1024x64xf16>, tensor<1024x64xf16>) outs(%fill : tensor<1024x1024xf32>) {

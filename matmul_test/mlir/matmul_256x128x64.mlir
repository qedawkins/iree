...
func.func @matmul_256x128x64(%lhs: tensor<256x64xf16>, %rhs: tensor<128x64xf16>) -> tensor<256x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<256x64xf16>, tensor<128x64xf16>) outs(%fill : tensor<256x128xf32>) {

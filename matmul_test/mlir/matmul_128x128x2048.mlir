...
func.func @matmul_128x128x2048(%lhs: tensor<128x2048xf16>, %rhs: tensor<128x2048xf16>) -> tensor<128x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<128x2048xf16>, tensor<128x2048xf16>) outs(%fill : tensor<128x128xf32>) {

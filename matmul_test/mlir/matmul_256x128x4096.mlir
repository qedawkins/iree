...
func.func @matmul_256x128x4096(%lhs: tensor<256x4096xf16>, %rhs: tensor<128x4096xf16>) -> tensor<256x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<256x4096xf16>, tensor<128x4096xf16>) outs(%fill : tensor<256x128xf32>) {

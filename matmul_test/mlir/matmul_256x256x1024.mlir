...
func.func @matmul_256x256x1024(%lhs: tensor<256x1024xf16>, %rhs: tensor<256x1024xf16>) -> tensor<256x256xf32> {
  ...
  } ins(%lhs, %rhs : tensor<256x1024xf16>, tensor<256x1024xf16>) outs(%fill : tensor<256x256xf32>) {

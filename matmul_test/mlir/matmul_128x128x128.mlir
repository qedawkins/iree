...
func.func @matmul_128x128x128(%lhs: tensor<128x128xf16>, %rhs: tensor<128x128xf16>) -> tensor<128x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<128x128xf16>, tensor<128x128xf16>) outs(%fill : tensor<128x128xf32>) {

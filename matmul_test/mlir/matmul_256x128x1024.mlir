...
func.func @matmul_256x128x1024(%lhs: tensor<256x1024xf16>, %rhs: tensor<128x1024xf16>) -> tensor<256x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<256x1024xf16>, tensor<128x1024xf16>) outs(%fill : tensor<256x128xf32>) {

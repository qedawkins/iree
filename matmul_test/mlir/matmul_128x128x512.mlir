...
func.func @matmul_128x128x512(%lhs: tensor<128x512xf16>, %rhs: tensor<128x512xf16>) -> tensor<128x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<128x512xf16>, tensor<128x512xf16>) outs(%fill : tensor<128x128xf32>) {

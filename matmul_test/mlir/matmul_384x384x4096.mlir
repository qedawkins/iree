...
func.func @matmul_384x384x4096(%lhs: tensor<384x4096xf16>, %rhs: tensor<384x4096xf16>) -> tensor<384x384xf32> {
  ...
  } ins(%lhs, %rhs : tensor<384x4096xf16>, tensor<384x4096xf16>) outs(%fill : tensor<384x384xf32>) {

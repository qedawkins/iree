...
func.func @matmul_2048x2048x64(%lhs: tensor<2048x64xf16>, %rhs: tensor<2048x64xf16>) -> tensor<2048x2048xf32> {
  ...
  } ins(%lhs, %rhs : tensor<2048x64xf16>, tensor<2048x64xf16>) outs(%fill : tensor<2048x2048xf32>) {

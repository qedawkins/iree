...
func.func @matmul_128x128x4096(%lhs: tensor<128x4096xf16>, %rhs: tensor<128x4096xf16>) -> tensor<128x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<128x4096xf16>, tensor<128x4096xf16>) outs(%fill : tensor<128x128xf32>) {

...
func.func @matmul_128x128x1024(%lhs: tensor<128x1024xf16>, %rhs: tensor<128x1024xf16>) -> tensor<128x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<128x1024xf16>, tensor<128x1024xf16>) outs(%fill : tensor<128x128xf32>) {

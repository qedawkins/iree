...
func.func @matmul_128x128x64(%lhs: tensor<128x64xf16>, %rhs: tensor<128x64xf16>) -> tensor<128x128xf32> {
  ...
  } ins(%lhs, %rhs : tensor<128x64xf16>, tensor<128x64xf16>) outs(%fill : tensor<128x128xf32>) {

...
func.func @matmul_2048x2048x256(%lhs: tensor<2048x256xf16>, %rhs: tensor<2048x256xf16>) -> tensor<2048x2048xf32> {
  ...
  } ins(%lhs, %rhs : tensor<2048x256xf16>, tensor<2048x256xf16>) outs(%fill : tensor<2048x2048xf32>) {
